namespace Univerity
{
	partial class Menu
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Просмотр расписания";
			...
			this.button2.Text = "Удаление/Редактирование\r\nинформации";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.button2_Click);
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(69, 90);
			this.button4.Name = "button4";
			this.button4.Size = new System.Drawing.Size(234, 49);
			this.button4.TabIndex = 3;
			this.button4.Text = "Поставить пару";
			this.button4.UseVisualStyleBackColor = true;
			// 
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(69, 347);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(234, 47);
			this.button5.TabIndex = 4;
			this.button5.Text = "Информация о разработчике";
			this.button5.UseVisualStyleBackColor = true;
			// 
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(109, 455);
